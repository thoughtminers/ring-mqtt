...
export default new class Mqtt {
    ...
    async init() {
        try {
            ...
            // Disable MQTT v5 topic alias to avoid crashes with brokers that don't fully support it
            mqttOptions.properties = { ...mqttOptions.properties, topicAliasMaximum: 0 }
